...
> **AI 必须做的事**：进入项目第一件事是读这份 YAML，理解项目背景再动手。
> **禁止做的事**：不了解项目就盲改代码。
...
```yaml
# === AI 在本项目的角色 ===
主导级别：对话协作（AI 建议，人类审核）    # 不要轻易升级到"AI 主导"
...
7. **`04-Evals/regression-cases.json` 套件**配合本文件使用，作为回归测试基线
...
> _版本：v1.1（2026-09-05）· harness-kit_
